...
This project is mainly based on SSD, which is a presentative single stage method for object detection. In order to impove the preformance of SSD, we can use GIOU, DIOU and CIOU as well as focal loss to deal with the shortage of the original algorithm. 
